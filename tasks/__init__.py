...
from tasks.hard import HARD_TASK_CONFIG, HARD_MULTI_STEP_TASK_CONFIG  # ← added

ALL_TASKS = {
    "easy_fraud_detection": EASY_TASK_CONFIG,
    "medium_risk_analysis": MEDIUM_TASK_CONFIG,
    "hard_decision_making": HARD_TASK_CONFIG,
    "hard_multi_step": HARD_MULTI_STEP_TASK_CONFIG,               # ← added
}
...
__all__ = [
    ...
    "MEDIUM_TASK_CONFIG",
    "HARD_TASK_CONFIG",
    "HARD_MULTI_STEP_TASK_CONFIG",                                 # ← added
]